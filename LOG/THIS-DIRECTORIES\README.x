...
,::.\/*etcetera-solale-forth**secetera-solale-forth**:,:**triaging**BIT(s).BYTE(s)**'every_before-after'*-all-*';-calendar-time-dating,:,'past,flaged and futures-future'**-fiscal-barter-*\/:,:
